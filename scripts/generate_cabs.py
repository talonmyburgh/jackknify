...
def main():
    """Generate cabs for all CLI functions in src/jackknify/cli."""
    ...
    cli_dir = Path("src/jackknify/cli")
    ...
    cabs_dir = Path("src/jackknify/cabs")
    ...
    image_name = f"ghcr.io/talonmyburgh/jackknify:{image_tag}"
